...
case $SLURM_ARRAY_TASK_ID in
    1)
        ...
        ;;
    2)
        CASE_NAME="cutoff_50x_fixed"
        ENABLE_COULOMB=1
        CUTOFF_MULT=50
        USE_BIMODAL=0
        ;;
    3)
        CASE_NAME="cutoff_100x_fixed"
        ENABLE_COULOMB=1
        CUTOFF_MULT=100
        USE_BIMODAL=0
        ;;
    4)
        CASE_NAME="cutoff_150x_fixed"
        ENABLE_COULOMB=1
        CUTOFF_MULT=150
        USE_BIMODAL=0
        ;;
    5)
        CASE_NAME="cutoff_200x_fixed"
        ENABLE_COULOMB=1
        CUTOFF_MULT=200
        USE_BIMODAL=0
        ;;
    6)
        CASE_NAME="cutoff_50x_bimodal"
        ENABLE_COULOMB=1
        CUTOFF_MULT=50
        USE_BIMODAL=1
        ;;
    7)
        CASE_NAME="cutoff_100x_bimodal"
        ENABLE_COULOMB=1
        CUTOFF_MULT=100
        USE_BIMODAL=1
        ;;
    8)
        CASE_NAME="cutoff_150x_bimodal"
        ENABLE_COULOMB=1
        CUTOFF_MULT=150
        USE_BIMODAL=1
        ;;
    9)
        CASE_NAME="cutoff_200x_bimodal"
        ENABLE_COULOMB=1
        CUTOFF_MULT=200
        USE_BIMODAL=1
        ;;
