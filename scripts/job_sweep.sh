...
# 実行したい入力ファイルを列挙
INPUT_FILES=(
    "inputs/rolling_friction_study/input_rolling_friction_0.8.dat"
    "inputs/rolling_friction_study/input_rolling_friction_1.0.dat"
)
...
BUILD_DIR_ROOT="build/job_rolling_friction_study"
