...
ax.scatter(friction_coeffs, angles_friction, s=100, c='tab:blue', 
           marker='o', zorder=5, label='シミュレーション結果')
ax.plot(friction_coeffs, angles_friction, 'tab:blue', alpha=0.7, linewidth=1.5)

ax.set_xlabel(r'滑り摩擦係数 $\mu$ [-]', fontsize=12)
ax.set_ylabel(r'安息角 $\theta_r$ [deg]', fontsize=12)
ax.set_xlim(-0.05, 1.05)
ax.set_ylim(0, 15)
ax.grid(True, alpha=0.3)
ax.legend(loc='upper left', fontsize=11)
ax.set_title('摩擦係数と安息角の関係', fontsize=14)
...
ax.scatter(rolling_friction_coeffs, angles_rolling, s=100, c='tab:orange', 
           marker='s', zorder=5, label='シミュレーション結果')
ax.plot(rolling_friction_coeffs, angles_rolling, 'tab:orange', alpha=0.7)

ax.set_xlabel(r'転がり摩擦係数 $\mu_r$ [-]', fontsize=12)
ax.set_ylabel(r'安息角 $\theta_r$ [deg]', fontsize=12)
ax.set_xlim(-0.05, 1.05)
ax.set_ylim(0, 15)
ax.grid(True, alpha=0.3)
ax.legend(loc='upper left', fontsize=11)
ax.set_title('転がり摩擦係数と安息角の関係', fontsize=14)
...
ax1.set_xlabel(r'滑り摩擦係数 $\mu$ [-]', fontsize=12)
ax1.set_ylabel(r'安息角 $\theta_r$ [deg]', fontsize=12)
ax1.set_xlim(-0.05, 1.05)
ax1.set_ylim(0, 15)
ax1.grid(True, alpha=0.3)
ax1.legend(loc='upper left', fontsize=10)
ax1.set_title('(a) 滑り摩擦係数の影響', fontsize=12)
...
ax2.set_xlabel(r'転がり摩擦係数 $\mu_r$ [-]', fontsize=12)
ax2.set_ylabel(r'安息角 $\theta_r$ [deg]', fontsize=12)
ax2.set_xlim(-0.05, 1.05)
ax2.set_ylim(0, 15)
ax2.grid(True, alpha=0.3)
ax2.legend(loc='upper left', fontsize=10)
ax2.set_title('(b) 転がり摩擦係数の影響', fontsize=12)
