...
def main() -> None:
    ...
    csv_path = os.path.join(data_dir, "damped_oscillator.csv")
    out_png_full = os.path.join(data_dir, "damped_oscillator.png")
    out_png_half = os.path.join(data_dir, "damped_oscillator_half_period.png")
    ...
    # 理論値 (damped_oscillator.f90で定義されている値)
    restitution_coeff_e = 0.8
    ...
    if half_range is not None:
        ...
        plot_data(t_half, xn_half, vn_half, xt_half, vt_half, out_png_half, "(Half Period)")
